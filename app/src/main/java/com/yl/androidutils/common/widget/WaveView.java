...
public class WaveView extends View {
    ...
    //渐变背景的起始和结束颜色
    private int mGradientStartColor = Color.parseColor("#FF0000");
    private int mGradientEndColor = Color.parseColor("#FF6600");
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mWavePath1.rQuadTo(w / 4, h / 8, w / 2, 0);
        mWavePath1.rQuadTo(w / 4, -h / 8, w / 2, 0);
        mWavePath1.rQuadTo(w / 4, h / 8, w / 2, 0);
        mWavePath1.rQuadTo(w / 4, -h / 8, w / 2, 0);
        ...
        mWavePath2.rQuadTo(w / 4, h / 8, w / 2, 0);
        mWavePath2.rQuadTo(w / 4, -h / 8, w / 2, 0);
        mWavePath2.rQuadTo(w / 4, h / 8, w / 2, 0);
        mWavePath2.rQuadTo(w / 4, -h / 8, w / 2, 0);
        mWavePath2.rQuadTo(w / 4, h / 8, w / 2, 0);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.save();
        canvas.translate(-getWidth() * mAnimProgress, getHeight() / 3.4f);
        canvas.drawPath(mWavePath1, mPaint);
        canvas.restore();

        canvas.save();
        canvas.translate(-getWidth() * 2 * mAnimProgress, getHeight() / 3.4f);
