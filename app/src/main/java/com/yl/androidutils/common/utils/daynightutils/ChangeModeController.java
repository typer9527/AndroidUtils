package com.yl.androidutils.common.utils.daynightutils;//package com.gh.okmaster.utils.daynightutils;
//
...
//                                mBackGroundViews.add(new AttrEntity<View>(view, getAttr(mClass, attrs
//                                        .getAttributeValue(i))));
//                            }
//                            if (attrs.getAttributeName(i).equals(ATTR_TEXTCOLOR)) {
//                                mOneTextColorViews.add(new AttrEntity<TextView>((TextView) view, getAttr
//                                        (mClass, attrs.getAttributeValue(i))));
//                            }
...
//                                mBackGroundDrawableViews.add(new AttrEntity<View>(view, getAttr(mClass,
...
//        if (mBackGroundDrawableViews == null || mOneTextColorViews == null || mTwoTextColorViews == null ||
//                mThreeTextColorViews == null || mBackGroundViews == null) {
//            throw new RuntimeException("请先调用init()初始化方法!");
//        }
...
//
//            ViewGroup.LayoutParams layoutParam = new ViewGroup.LayoutParams(ViewGroup.LayoutParams
//                    .MATCH_PARENT,
