...
public class RxGalleryMyApi {
    ...
    private static RxGalleryMyApi mRxApi = new RxGalleryMyApi();
     ...
     */
    public static RxGalleryMyApi getInstance(Activity context) {
        if (context == null) {
     ...
     */
    public static RxGalleryMyApi openRadioSelectImage(Activity context, RxBusResultDisposable<ImageRadioResultEvent> rxBusResultDisposable, boolean flag) {
        getInstance(context);
        if (flag) {
            rxGalleryFinal
                    .image()
     ...
     */
    public RxGalleryMyApi onCropImageResult(IRadioImageCheckedListener listener) {
     ...
     * @return RxGalleryFinalApi
     */
    public static RxGalleryMyApi onMultiImageResult(IMultiImageCheckedListener listener) {
     ...
     * 得到多选限制事件
     */
    public static RxGalleryMyApi onCrop(boolean flag) {
     ...
     * 单选默认设置
     */
    public RxGalleryMyApi openGalleryRadioImgDefault(RxBusResultDisposable<ImageRadioResultEvent> rxBusResultDisposable) {
     ...
     * 得到多选限制事件
     */
    public static RxGalleryMyApi openGallery() {
        if (rxGalleryFinal == null)
            return null;
    ...
    public static int openZKCamera(Object activity) {
        ...
        if (captureIntent.resolveActivity(cameraActivity.getPackageManager()) != null) {
            ...
            Toast.makeText(cameraActivity, "相机不可用", Toast.LENGTH_SHORT).show();
            return -1;
        }
    }
     ...
     */
    public RxGalleryMyApi setType(int type, int mt) {
        switch (type) {
     ...
     * 设置单选的按钮事件
     */
    public RxGalleryMyApi setImageRadioResultEvent(RxBusResultDisposable<ImageRadioResultEvent> t) {
        rxGalleryFinal.image();
     ...
     * 设置多选的按钮事件
     */
    public RxGalleryMyApi setImageMultipleResultEvent(RxBusResultDisposable<ImageMultipleResultEvent> t) {
        rxGalleryFinal.image();
        rxGalleryFinal.subscribe(t);
        return mRxApi;
    }
     ...
     * 设置视频单选的按钮事件
     */
    public RxGalleryMyApi setVDRadioResultEvent(RxBusResultDisposable<ImageRadioResultEvent> t) {
        rxGalleryFinal.video();
        rxGalleryFinal.subscribe(t);
        return mRxApi;
    }
     ...
     * 设置视频多选的按钮事件
     */
    public RxGalleryMyApi setVDMultipleResultEvent(RxBusResultDisposable<ImageMultipleResultEvent> t) {
        rxGalleryFinal.video();
        rxGalleryFinal.subscribe(t);
        return mRxApi;
    }

    public RxGalleryMyApi setCrop() {
        rxGalleryFinal.crop();
        return mRxApi;
    }
