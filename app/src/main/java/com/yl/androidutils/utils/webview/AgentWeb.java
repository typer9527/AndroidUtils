...
import com.dawei.okmaster.utils.LogUtils;
...
public class AgentWeb {
    ...
    private AgentWeb(AgentBuilder agentBuilder) {
        ...
        mWebCreator = agentBuilder.mWebCreator == null ? configWebCreator(agentBuilder.v, agentBuilder
                .index, agentBuilder.mLayoutParams, agentBuilder.mIndicatorColor, agentBuilder
                .mIndicatorColorWithHeight, agentBuilder.mWebView) : agentBuilder.mWebCreator;
        ...
        mWebSecurityController = new WebSecurityControllerImpl(mWebCreator.get(), this.mAgentWeb
                .mJavaObjects, mSecurityType);
    ...
    public AgentWeb(AgentBuilderFragment agentBuilderFragment) {
        ...
        mWebCreator = agentBuilderFragment.mWebCreator == null ? configWebCreator(agentBuilderFragment.v,
                agentBuilderFragment.index, agentBuilderFragment.mLayoutParams, agentBuilderFragment
                        .mIndicatorColor, agentBuilderFragment.height_dp, agentBuilderFragment.mWebView) :
                agentBuilderFragment.mWebCreator;
        ...
        this.mILoader = new LoaderImpl(mWebCreator.create().get(), agentBuilderFragment
                .additionalHttpHeaders);
        this.mWebLifeCycle = new DefaultWebLifeCycleImpl(mWebCreator.get());
        mWebSecurityController = new WebSecurityControllerImpl(mWebCreator.get(), this.mAgentWeb
                .mJavaObjects, this.mSecurityType);
    ...
    private void doCompat() {
        ...
        mJavaObjects.put("agentWeb", mAgentWebJsInterfaceCompat = new AgentWebJsInterfaceCompat(this,
                mActivity));
        LogUtils.i(TAG, "AgentWebConfig.isUseAgentWebView:" + AgentWebConfig.WEBVIEW_TYPE + "  " +
                "mChromeClientCallbackManager:" + mChromeClientCallbackManager);
        if (AgentWebConfig.WEBVIEW_TYPE == AgentWebConfig.WEBVIEW_AGENTWEB_SAFE_TYPE) {
            this.mChromeClientCallbackManager.setAgentWebCompatInterface((ChromeClientCallbackManager
                    .AgentWebCompatInterface) mWebCreator.get());
            this.mWebViewClientCallbackManager.setPageLifeCycleCallback((WebViewClientCallbackManager
                    .PageLifeCycleCallback) mWebCreator.get());
        }
    ...
    private WebCreator configWebCreator(BaseIndicatorView progressView, int index, ViewGroup.LayoutParams
            lp, int mIndicatorColor, int height_dp, WebView webView) {
    ...
    private void loadDataWithBaseURL(String baseUrl, String data, String mimeType, String encoding, String
            history) {
    ...
    public IEventHandler getIEventHandler() {
        return this.mIEventHandler == null ? (this.mIEventHandler = EventHandlerImpl.getInstantce
                (mWebCreator.get(), getInterceptor())) : this.mIEventHandler;
    }
    ...
    private AgentWeb ready() {
        ...
        if (mJsInterfaceHolder == null) {
            mJsInterfaceHolder = JsInterfaceHolderImpl.getJsInterfaceHolder(mWebCreator.get(), this
                    .mSecurityType);
        }
    ...
    private DownloadListener getLoadListener() {
        ...
        if (mDownloadListener == null) {
            this.mDownloadListener = mDownloadListener = new DefaultDownLoaderImpl(mActivity
    ...
    private WebChromeClient getChromeClient() {
        IndicatorController mIndicatorController = (this.mIndicatorController == null) ? IndicatorHandler
                .getInstance().inJectProgressView(mWebCreator.offer()) : this.mIndicatorController;
        /*if (mWebChromeClient != null) {
            return enableProgress ? new WebChromeClientProgressWrapper(mIndicatorController,
            mWebChromeClient) : mWebChromeClient;
        } else {
            return new DefaultChromeClient(this.mActivity, mIndicatorController, this
            .mChromeClientCallbackManager);
        }*/

        return this.mTargetChromeClient = new DefaultChromeClient(this.mActivity, mIndicatorController,
                mWebChromeClient, this.mChromeClientCallbackManager, this.mIVideo = getIVideo());
    }
    ...
    private WebViewClient getClient() {
        if (!webClientHelper && AgentWebConfig.WEBVIEW_TYPE != AgentWebConfig.WEBVIEW_AGENTWEB_SAFE_TYPE &&
                mWebViewClient != null) {
            return mWebViewClient;
        } else {
            return new DefaultWebClient(mActivity, this.mWebViewClient, this.mWebViewClientCallbackManager,
                    webClientHelper);
        }
    ...
    public static class AgentBuilder {
        ...
        private WebSettings mWebSettings;
        private WebCreator mWebCreator;
        private WebViewClientCallbackManager mWebViewClientCallbackManager = new
                WebViewClientCallbackManager();
        private SecurityType mSecurityType = SecurityType.default_check;
        ...
        public ConfigIndicatorBuilder setAgentWebParent(ViewGroup viewGroup, ViewGroup.LayoutParams lp, int
                position) {
            this.mViewGroup = viewGroup;
            mLayoutParams = lp;
            this.index = position;
    ...
    public static class PreAgentWeb {
        ...
        public AgentWeb go(@Nullable String url) {
            if (!isReady) {
//                throw new IllegalStateException(" please call ready before go  to finish all webview
// settings");  //i want to do this , but i cannot;
                ready();
            }
    ...
    public static class CommonAgentBuilder {
        ...
        public CommonAgentBuilder setReceivedTitleCallback(ChromeClientCallbackManager
    ...
    public static class CommonBuilderForFragment {
        ...
        public CommonBuilderForFragment setReceivedTitleCallback(ChromeClientCallbackManager
                                                                         .ReceivedTitleCallback
                                                                         receivedTitleCallback) {
            this.mAgentBuilderFragment.mChromeClientCallbackManager.setReceivedTitleCallback
                    (receivedTitleCallback);
            return this;
        }
