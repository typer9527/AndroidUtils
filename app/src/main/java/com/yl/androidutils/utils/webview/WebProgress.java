...
public class WebProgress extends BaseIndicatorView implements BaseProgressSpec {
    ...
    protected void onDraw(Canvas canvas) {
     ...
     /*   Log.i("Info", "re:" + (currentProgress / 100 * Float.valueOf(this.getWidth())) + "  width:" +
     this.getWidth() + "  height:" + this.getHeight() + "  left:" + getLeft() + "  right:" + getRight() + "
       b:" + this.getBottom() + " top:" + this.getTop());*/
...
//        super.dispatchDraw(canvas);
        canvas.drawRect(0, 0, currentProgress / 100 * Float.valueOf(this.getWidth()), this.getHeight(),
                mPaint);
    }
...
//        Log.i("Info", "currentProgress:" + currentProgress + "  value:" + v);
        ...
        /*默认每个像素8毫秒*/
        mValueAnimator.setDuration(isAuto ? duration * 8 : (long) (duration * weightDuration(v,
                currentProgress)));
