...
public class CircleProgressView extends ProgressBar {
    ...
    private void initPaint() {
        ...
        mNormalPaint.setStyle(mProgressStyle == ProgressStyle.FILL_IN_ARC ? Paint.Style.FILL : Paint.Style
                .STROKE);
        ...
        mReachPaint.setStyle(mProgressStyle == ProgressStyle.FILL_IN_ARC ? Paint.Style.FILL : Paint.Style
                .STROKE);
    ...
    private void obtainAttributes(AttributeSet attrs) {
        ...
        // 获取三种风格通用的属性
        mNormalBarSize = (int) ta.getDimension(R.styleable.CircleProgressView_cpv_progressNormalSize,
                mNormalBarSize);
        mNormalBarColor = ta.getColor(R.styleable.CircleProgressView_cpv_progressNormalColor,
                mNormalBarColor);

        mReachBarSize = (int) ta.getDimension(R.styleable.CircleProgressView_cpv_progressReachSize,
                mReachBarSize);
        ...
        switch (mProgressStyle) {
            ...
            case ProgressStyle.FILL_IN_ARC:
                ...
                mInnerPadding = (int) ta.getDimension(R.styleable.CircleProgressView_cpv_innerPadding,
                        mInnerPadding);
            ...
            case ProgressStyle.NORMAL:
                ...
                if (ta.hasValue(R.styleable.CircleProgressView_cpv_innerBackgroundColor)) {
                    mInnerBackgroundColor = ta.getColor(R.styleable
                            .CircleProgressView_cpv_innerBackgroundColor, Color.argb(0, 0, 0, 0));
